      ...
      <section className="h-screen flex items-center justify-center">
        <div className="max-w-[1220px] mx-auto px-4 lg:px-6">
          ...
          <div className="max-w-2xl mx-auto text-center space-y-4">
            <h1 className="text-[24px] lg:text-[36px]  font-bold uppercase">
              Uh Oh! looks like something broke
            </h1>
            <h2 className="text-[18px] lg:text-[24px]  font-bold uppercase">
              Page Not Found
            </h2>
            ...
            <div className="pt-4">
              <Link
                href="/"
                passHref
                className="font-bold bg-primary border-primary border text-white px-12 py-2 lg:py-3 mt-6 rounded-full  transition-all duration-300 ease-in-out text-lg lg:text-xl hover:bg-transparent hover:text-primary"
              >
                Take Me Away
              </Link>
            </div>
...
PageNotFound404.isNotFoundPage = true
