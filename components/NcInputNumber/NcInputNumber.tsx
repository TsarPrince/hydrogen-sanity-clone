...
const NcInputNumber: FC<NcInputNumberProps> = ({
  ...
  const renderLabel = () => {
    return (
      <div className="flex flex-col">
        ...
        {desc && <span className="text-xs font-normal">{desc}</span>}
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="w-8 h-8 rounded-full flex items-center justify-center border border-neutral-700 bg-white focus:outline-none hover:border-neutral-700 disabled:hover:border-neutral-400 disabled:opacity-50 disabled:cursor-default"
          type="button"
