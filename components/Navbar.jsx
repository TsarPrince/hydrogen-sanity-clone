        ...
        <div className="absolute right-0 flex h-full items-center md:mr-4">
          <div className="hidden lg:block">
            <div className="relative inline-flex">
              <button
                className="flex h-[2.4rem] items-center rounded-sm bg-darkGray bg-opacity-0 px-3 py-2 text-sm font-bold duration-150 hover:bg-opacity-10"
                id="headlessui-listbox-button-:R1iokp:"
                type="button"
                aria-haspopup="listbox"
                aria-expanded="false"
                data-headlessui-state=""
              >
                <span className="mr-2">United States (USD $)</span>
                <svg
                  width="12"
                  height="12"
                  viewBox="0 0 12 12"
