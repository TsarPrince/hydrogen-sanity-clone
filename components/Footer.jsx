      ...
      <div className="align-start relative overflow-hidden rounded-xl bg-peach px-4 py-8 md:px-8 md:py-10">
        <div className="flex flex-col justify-between md:flex-row">
          ...
          <div className="my-16 w-full max-w-[22rem] columns-2 gap-x-8 self-start text-md font-bold md:my-0 md:max-w-[27rem]">
            <div className="mb-6">
              <a className="linkTextNavigation" href="/pages/shipping">
                Shipping &amp; Returns
              </a>
            </div>
            <div className="mb-6">
              <a className="linkTextNavigation" href="/pages/contact">
                Contact us
              </a>
            </div>
            <div className="mb-6">
              <a className="linkTextNavigation" href="/pages/privacy">
                Privacy
              </a>
            </div>
            <div className="mb-6">
            ...
            <div className="mb-6">
              <a className="linkTextNavigation" href="/pages/playground">
      ...
      <div className="-my-overlap bg-[#121923] pt-overlap text-white">
        <div className="mx-auto max-w-[47rem] px-4 py-12 text-center text-xl leading-caption md:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 text-left text-sm leading-caption md:grid-cols-3">
            <a
              className="space-y-3 rounded-sm border border-white border-opacity-20 p-4 duration-500 ease-out hover:bg-white hover:bg-opacity-5"
            ...
            >
              ...
              <div>
                Install Sanity Connect for free on the Shopify App Store
              </div>
            </a>
          </div>
          <a
